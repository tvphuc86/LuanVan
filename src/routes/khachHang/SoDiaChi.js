...
function SoDiaChi() {
    ...
    useEffect( () => {
       retrieveData(page,limit,values.maTaiKhoan)
    },[page,limit,values])
    const retrieveData = (page,limit,maTaiKhoan)=> {
        SoDiaChiService.get(page,limit,maTaiKhoan)
        .then( rs => {
  ...
  return (
    <div>
      ...
      <div className="content">
        <h1 style={{'padding':'1rem'}}>Quản lý sổ địa chỉ</h1>
